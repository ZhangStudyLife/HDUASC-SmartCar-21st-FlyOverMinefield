...
<p align="center">
  <img src="image/README/浙江省赛区飞跃雷区一等奖证书.png" width="70%" alt="第十五届浙江省大学生智能汽车竞赛暨第二十一届全国大学生智能汽车竞赛浙江赛区选拔赛·飞跃雷区一等奖证书">
</p>
...
## 感谢一路支持我们拿到飞跃赛区全国冠军的所有人

我们能获得飞跃赛区的全国冠军。

首先离不开杭电自动化学院的高度重视与全力支持——从经费保障到物资调配，从实验场地到技术支撑，学院全方位为我们搭建了坚实的备赛平台。

然后离不开实验室指导老师**余善恩老师**的悉心教导，从赛题一出来，到全流程的陪伴和方案的指导建议。

然后离不开我们实验室的轮腿学长*@**江秉臻**@**张旭望** 学长的鼓励和支持。他们是我们实验室去年唯一一队国一的队伍，也是陪伴我大一打 NXP 的学长。

令人可惜的是，我们竞争组别的**杭电 AIOT 电磁实验室**的雷区对手，他们校赛的三摄方案拿出来，让我坚定了调下去的勇气。虽然省赛他们比我们慢了一两秒，但我说实话，没有和他们校赛的交流，

我也只能再次拿一次省三的奖项。他们是最最可敬的对手，他们的努力和付出不应该只有一个省奖的回报。

离不开 **山东工商学院** 的曹海彬（阿牛佬）的硬件支持。由于我们队伍第一个硬件队友的摆烂，顶替上来的硬件学弟也欠缺经验，没有阿牛佬的电调参考和热心的远程指导，我们恐怕连校赛连自制电调都拿不出来。

离不开太原工业学院、中原工学院、中国计量大学、东北大学秦皇岛分校、华侨大学、西南科技大学的同志们交流进步，一路过来，很是感慨。

## 提问和补充文档

如果你在复刻本项目或者对于哪里我没有描述清楚的地方 , 可以在提交本项目的issue

我看到了只要是真的没有在文档里面体现出来的 , 或者我觉得确实是我没讲清楚的地方,我会第一时间更新文档

最近我也比较繁忙,如果不能及时解决issue提问也很抱歉

如果是代码具体的问题 , 现在AI也很发达了,语法问题或者是某个文件代码是啥意思的这种问题 , 恐怕提问了我也只会用AI来看我的代码来给你回答,而且代码本身我觉得不是很重要

主要还是对于 单片机实时性的理解 (非堵塞) , 时间片的分配 , 调试技术的学习 , 姿态解算的滤波器设计 , 飞机跟车的控制器的设计
